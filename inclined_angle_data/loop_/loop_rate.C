...
void loop_rate() {
    TCanvas *c1 = new TCanvas("c1", "rate analysis", 1200, 800);
  ...
  string _data = " Photon rate detected by sensor";
  ...
  gr_xcen->SetMarkerColor(kViolet);
    ...
    c1->Update();
    c1->Draw();
    string outfile = "results/loop_rate.png";
